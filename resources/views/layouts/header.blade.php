            ...
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li @if($header == 'For Review') class='active' @endif>
                        <a href="{{ url('/for-review') }}" class='active' onclick='show()' ><i class="fa fa-list-alt"></i> <span class="nav-label">For Review</span> </a>
                    </li>
                    <li @if($header == 'For Verification') class='active' @endif>
                        <a href="{{ url('/for-verification') }}" class='active' onclick='show()' ><i class="fa fa-paste"></i> <span class="nav-label">For Verification</span> </a>
                    </li>
                    <li @if($header == 'For Payment') class='active' @endif>
                        <a href="{{ url('/for-payment') }}" class='active' onclick='show()' ><i class="fa fa-money"></i> <span class="nav-label">For Payment</span> </a>
                    </li>
                    <li @if($header == 'Projects') class='active' @endif>
                        <a href="{{ url('/projects') }}" class='active' onclick='show()' ><i class="fa fa-list-ol"></i> <span class="nav-label">Projects</span> </a>
                    </li>
