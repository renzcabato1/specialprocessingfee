			...
			<div class="col-lg-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>Users
							<button class="btn btn-primary" data-target="#new_account" data-toggle="modal" type="button"><i
										...
										<td data-id='{{ $user->id }}' id='actionuser{{ $user->id }}'>
											...
											@else
												<button type="button" title="Reset Password" data-toggle="modal"
													data-target="#change_pass{{ $user->id }}" class="btn btn-sm btn-warning">
													<i class="fa fa-unlock"></i>
												</button>
												<button class="btn btn-sm btn-info" title='Edit' data-target="#editUser{{ $user->id }}"
													data-toggle="modal"><i class="fa fa-edit"></i></button>
												@if (Auth::user()->id != $user->id)
													<button class="btn btn-sm btn-danger deactivate-user" title='Deactivate'><i class="fa fa-ban"></i></button>
												@endif
											@endif
										</td>
									</tr>
